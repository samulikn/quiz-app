...
function Score() {
  ...
  return (
    <div className="w-full pt-8 px-6 flex flex-col gap-10 sm:px-0 sm:gap-16 
                    xl:flex-row xl:gap-32 xl:justify-between">
      ...
      <div className="xl:basis-1/2 xl:shrink-0 xl:pr-5 xl:pl-4">
        <article className="mb-4 p-8 bg-white rounded-2xl flex flex-col gap-4 items-center sm:mb-8 sm:p-12 sm:gap-10 sm:rounded-3xl dark:bg-blue-850">
          ...
          <div className="flex flex-col gap-3 xl:gap-5">
            <p className="font-medium text-8xl sm:text-10xl">{score}</p>
